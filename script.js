...
document.getElementById("calcolatore-semplicato").addEventListener("click", function () {
  const content = `
    <label>Compensazione arcata superiore (semplificata):</label>
    <select id="compensazione-semplice">
      <option value="0">Nulla</option>
      <option value="1">Moderato 10°-15°</option>
      <option value="2.2">Severa 20°-25°</option>
    </select>
    <label>Decompensazione arcata inferiore (semplificata):</label>
  ...
  `;
  showPopup("Calcolatore Semplificato", content, () => {
...
document.getElementById("calcolatore-avanzato").addEventListener("click", function () {
  const content = `
    ...
    <div class="popup-footer">
      <button id="consider-expansion">Considera valori di espansione dentale</button>
    </div>
  `;
  showPopup("Calcolatore Avanzato", content, () => {
  ...
  document.getElementById("consider-expansion").addEventListener("click", function () {
    const expansionContent = `
      <p>Inserisci i valori di espansione dentale:</p>
    ...
    `;
    showPopup("Espansione Dentale", expansionContent, () => {
